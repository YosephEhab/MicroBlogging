        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageAttachments_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageAttachmentId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageVariants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImageVariants_ImageAttachments_ImageAttachmentId",
                        column: x => x.ImageAttachmentId,
                        principalTable: "ImageAttachments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ImageAttachments_PostId",
                table: "ImageAttachments",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageVariants_ImageAttachmentId",
                table: "ImageVariants",
